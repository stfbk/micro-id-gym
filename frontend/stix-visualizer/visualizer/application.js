...
require(["domReady!", "stix2viz/stix2viz/stix2viz"], function (document, stix2viz) {
    ...
    /* ******************************************************
     * Handles content passed as parameter.
     * ******************************************************/
    function handleTextArgument(content, customConfig) {
      vizStixWrapper(content, customConfig);
      linkifyHeader();
    }
...
//     }
    ...
    function inflateCustomVisualizer(){
      content = document.getElementById("custom-visualizer-textarea").value;
      handleTextArgument(content, "");
      console.log(content);
    }
     ...
     * ******************************************************/
    if (document.getElementById("custom-visualizer-textarea") !== null) {
      inflateCustomVisualizer();
    } else {
